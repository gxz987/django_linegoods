...
from meidou_mall.utils.models import BaseModel
...
class Goods(BaseModel):
    ...
    # on_delete=models.PROTECT，删除关联数据，引发错误ProtectedError，是受保护的，由django级别抛出的
...
class SKU(BaseModel):
    ...
    goods = models.ForeignKey(Goods, on_delete=models.CASCADE, verbose_name='商品')
    category = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, verbose_name='三级类别')
    ...
    sales = models.IntegerField(default=0, verbose_name='销量')
    comments = models.IntegerField(default=0, verbose_name='评论量')
    is_launched = models.BooleanField(default=0, verbose_name='是否上架销售')
